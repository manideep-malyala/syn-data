...
(
    'Debit',
    'Platinum Debit Card',
    'Contactless payments, High withdrawal limit, Zero liability on fraud',
    500.00,
    500.00,
    3.50,
    0.00,
    ...
    100.00,
    200.00,
    'Minimum balance of 10,000 in linked account',
    'Premium Savings Account',
    'Travel insurance, Airport lounge access, Purchase protection'
),
(
    'Credit',
    'Gold Credit Card',
    'High credit limit, Cashback on fuel, EMI conversion',
    1000.00,
    1000.00,
    2.50,
    1.50,
    ...
    500.00,
    250.00,
    'Minimum income of 5,00,000 per annum, CIBIL score of 750+',
    NULL,
    'Fuel surcharge waiver, Complimentary insurance, Reward points'
),
(
    'Prepaid',
    'Gift Card',
    'Reloadable, Usable worldwide',
    50.00,
    0.00,
    3.00,
    0.00,
    ...
    0.00,
    100.00,
    'No specific criteria, Valid government ID',
    NULL,
    'No expiry, Easy replacement'
);
